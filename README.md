# Dinkie Icons [![build status](https://github.com/atelier-anchor/dinkie-icons/actions/workflows/build.yml/badge.svg)](https://github.com/atelier-anchor/dinkie-icons/actions/workflows/build.yml)
