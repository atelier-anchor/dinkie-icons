...
const iconComponentHelper = (
  name: string,
  size: number,
  path: string
): DefineComponent<DinkieIconProps> =>
  defineComponent({
    name: `${name}${size}`,
    render: () =>
...
export const DinkieIconCherries12 = iconComponentHelper(
  'DinkieIconCherries',
  12,
...
export const DinkieIconBirdFilled12 = iconComponentHelper(
  'DinkieIconBirdFilled',
  12,
  'M3 12h7v-1h1v-1h-1V9H9v1H4V9H3V6h1V5h1v1H4v3h5V8H8V7H7V6H6V2H5V1H2v1H1v1H0v1h1v6h1v1h1Zm0-8V3h1v1Zm0 0'
)

export const DinkieIconSmirkingFace12 = iconComponentHelper(
  'DinkieIconSmirkingFace',
  12,
...
export const DinkieIconTwitter12 = iconComponentHelper(
  'DinkieIconTwitter',
  12,
...
export const DinkieIconTwitter10 = iconComponentHelper(
  'DinkieIconTwitter',
  10,
